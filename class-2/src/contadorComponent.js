...
(() => {
    ...
    class ContadorComponent {
        ...
        prepararContadorProxy() {
            ...
            const contador = new Proxy({ //proxy é um event listener, quando mudar o valor de algo ele dispara o handler set
        ...
        inicializar() {
...

            {
                ...
                //apply muda o contexto dentro da funcao para um novo contexto passado por parametro
